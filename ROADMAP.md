...
- [x] Acciones de un clic: Marcar Asamblea, Marcar Conmemoración, Crear igual sin contenido, Cancelar esta reunión (las 4, solo en filas bloqueadas) + Mover a otro día (cualquier fila — ver nota abajo) — implementadas y deployadas 2026-09-13 (`occurrence-action`, `components/occurrence-action-dialog.tsx`). **Falta verificación manual** — ver PROGRESS.md.
