...
npm run zoom:upload-session    # sube la sesión recapturada a los secrets de GitHub y borra los pedazos sobrantes de la sesión anterior (evita hacerlo a mano)
